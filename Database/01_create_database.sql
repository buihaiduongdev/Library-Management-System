...
CREATE TABLE NhanVien(
	...
	MaNV VARCHAR(50) NOT NULL UNIQUE, -- Sửa từ NULL thành NOT NULL UNIQUE, Duy sửa
	MaTK INT NULL REFERENCES TaiKhoan(MaTK)
		ON DELETE SET NULL,
	HoTen NVARCHAR(50) NOT NULL,
	NgaySinh DATE,
...
CREATE TABLE SACH (
    ...
    MaNXB VARCHAR(50) NOT NULL FOREIGN KEY REFERENCES NHA_XUAT_BAN(MaNXB),
    MaTacGia VARCHAR(50) NOT NULL FOREIGN KEY REFERENCES TAC_GIA(MaTacGia),
    MaTheLoai VARCHAR(50) NOT NULL FOREIGN KEY REFERENCES THE_LOAI(MaTheLoai)
);
